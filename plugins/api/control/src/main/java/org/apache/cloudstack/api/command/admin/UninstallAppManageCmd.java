...
public class UninstallAppManageCmd extends BaseCmd {
    public static final Logger s_logger = Logger.getLogger(UninstallAppManageCmd.class.getName());

    private static final String s_name = "uninstallAppManageResponse";
    ...
    public void execute() {
        ...
        if (result) {
            ...
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "应用管理：卸载应用失败");
        }
    }
}
